...
\newcommand{\header}[9]{
    ...
    \parbox[b][0.625in][t]{6.5in}{
        ...
        \parbox[b][0.625in][t]{3.74in}
            {\href{https://www.oslobrains.no/}
            {\includegraphics[height=1in]{./lcbc_logo_tall.png}}}\hfill
...
\header{$head.address$}{$head.city$}{$head.country$}{$head.phone$}{$head.email$}{$sig.name$}{$head.dept$}
...
$if(sig.include)$
    ...
    $if(sig.sign)$
        \vspace{-0.2in}\includegraphics[height=0.5in]{$sig.sign$}
    $else$
        \\
    $endif$
    \\
