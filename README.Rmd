...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/noasr)](https://CRAN.R-project.org/package=noasr)
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://www.tidyverse.org/lifecycle/#experimental)
[![Codecov test coverage](https://codecov.io/gh/LCBC-UiO/noasr/branch/main/graph/badge.svg)](https://codecov.io/gh/LCBC-UiO/noasr?branch=main)
...
The vignette and other presentations or tutorials of the package can also be found online [here](https://lcbc-uio.github.io/noasr/)
