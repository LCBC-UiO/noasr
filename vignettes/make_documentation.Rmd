...
![Find the Rmd you are looking for and click its name.](vignette_img/github_edit1.png){width=100%}

In the next window, click on the pencil icon to start editing in the browser. 
![Click on the little pencil-icon to start editing in the browser](vignette_img/github_edit2.png){width=100%}
...
![Commit your changes](vignette_img/github_edit3.png){width=100%}
...
![](vignette_img/bookdown_addin.png){width=100%}
