...
|---|---|---|
|`grouping.var` | a vector of strings with the names of the columns for your categorical groups. Usually, "Sex" and "Site_Name" are added here. | `grouping.var = c("Sex","Site_Name")`|  
|`numeric.var` | a vector of strings with the names of the columns for you numeric covariates. Here we often add cognitive scores. | `numeric.var = "CVLT_A_Total`|
